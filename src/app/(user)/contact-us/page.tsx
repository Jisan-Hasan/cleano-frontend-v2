                            ...
                            <div className="grid md:grid-cols-2">
                                <div className="h-full pr-6">
                                    <p className="mt-3 mb-12 text-lg">
                                        Are you looking for a reliable laundry
                                        and dry cleaning service provider? We
                                        are here to help you. We are a
                                        professional laundry and dry cleaning
                                        service provider with years of
